...
export function AdminLogin({ onLogin }) {
  ...
  // Exemplo: pode restringir para "adminexclusive@..." ou personalizar.
  const DEFAULT_EMAIL_DEMO = "adminexclusive@exemplo.com";
  const DEMO_HINT = "adminexclusive@exemplo.com / admin";
        ...
        <CardContent>
          <form onSubmit={handleEntrar} className="flex flex-col gap-6 mt-2">
            ...
            <div className="text-xs text-center text-blue-400 mt-2">
              ...
              Email: <span className="font-semibold text-blue-800">{DEFAULT_EMAIL_DEMO}</span><br />
              Senha: <span className="font-semibold text-blue-800">admin</span>
            </div>
          </form>
        </CardContent>
      </Card>
